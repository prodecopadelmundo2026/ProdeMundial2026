...
export default async function AdminWhitelistPage({ searchParams }: Props) {
  ...
  // Auth + admin check using the user's session (auth.uid() must be set for RPCs)
  ...
  // Use same client (user session) so auth.uid() is available inside the RPC
      ...
      <div className="max-w-[860px] mx-auto">
        ...
        <div style={{ marginBottom: '28px' }}>
          ...
          <div className="flex items-end justify-between gap-4 flex-wrap">
            ...
            >
              Lista <em className="not-italic italic" style={{ color: '#FF6B00' }}>Blanca</em>
            </h1>
            <Link
              href="/admin"
