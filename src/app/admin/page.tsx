  ...
  return (
    <div style={{ padding: '20px 16px clamp(40px, 8vw, 72px)' }}>
      <div className="max-w-[860px] mx-auto">
        ...
        <section className="mb-6 rounded-[20px] p-5" style={{ background: 'linear-gradient(135deg, rgba(255,107,0,0.12), #101010 58%)', border: '1px solid rgba(255,107,0,0.3)' }}>
        ...
        {matches && matches.length > 0 && (
          <div id="admin-section-llave" style={{ scrollMarginTop: 20 }}>
            <AdminBracketSection
