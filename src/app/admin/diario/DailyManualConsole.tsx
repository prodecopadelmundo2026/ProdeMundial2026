...
export function DailyManualConsole({ actor }: Props) {
  ...
  function saveBasics() {
    ...
    update({ ...selected.event, scheduledStart: nextStart, participants: { home: { ...selected.event.participants.home, name: homeName.trim() }, away: { ...selected.event.participants.away, name: awayName.trim() } } }, 'Participantes y horario actualizados en memoria.')
  }
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.warning}><ShieldAlert size={20} /><div><strong>Datos de demostración — fuente manual</strong><p>No hay proveedor integrado, sincronización automática, escritura en Supabase ni operación de premios reales.</p></div></section>
