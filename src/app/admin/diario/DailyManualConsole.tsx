...
import { dailyEvents, demoJourneys } from '@/lib/daily-prode-demo'
import { competitionFor, competitionsFor, isEligibleDailyEvent } from '@/lib/daily-prode/competition-catalog'
...
export function DailyManualConsole({ actor }: Props) {
  ...
  return <main className={styles.page}>
    <header className={styles.header}>
      <div><p className={styles.eyebrow}>ADMINISTRACIÓN PROTEGIDA / DESARROLLO</p><h1>Jornada manual</h1><p>Fuente: <strong>sourceType: manual</strong>. Estado local, sintético y descartable al recargar.</p></div>
      <Link className={styles.link} href="/admin">Volver al panel histórico</Link>
    </header>

    <section className={styles.warning}><ShieldAlert size={20} /><div><strong>Modo manual de desarrollo — cambios no persistentes</strong><p>Datos de demostración — fuente manual. No hay proveedor integrado, sincronización automática, escritura en Supabase ni operación de premios reales.</p></div></section>
