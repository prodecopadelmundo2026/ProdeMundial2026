      ...
      {hasRealScore ? (
        ...
        <>
          ...
          {showPrediction && readOnly && prediction && (
            <div
              className="flex min-h-[38px] items-center justify-between px-3 py-2 rounded-[10px] text-[11px] font-bold"
              style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}
            >
              <span className="text-muted tracking-[0.12em] uppercase text-[10px] font-extrabold">Tu pronóstico</span>
              <span className="font-mono text-[12px]" style={{ color: prediction ? '#fff' : '#4a4a4a' }}>
