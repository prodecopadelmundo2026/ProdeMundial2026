...
export function buildStatisticsData({
  ...
  const serious = [
    ...
    makeCard('day-exact', 'Más marcadores exactos en una fecha', timelineRows, (m) => m.bestDayExact, String, 'Récord diario de marcadores exactos'),
    makeCard('top3-days', 'Más veces en top 3', timelineRows, (m) => m.top3Days, (v) => `${v} días`, 'Presencias diarias en el podio'),
    makeCard('exact', 'Más marcadores exactos', metrics, (m) => m.exact, String, 'Marcadores acertados al detalle'),
    makeCard('signs', 'Más ganadores/empates acertados', metrics, (m) => m.signs, String, 'Incluye marcadores exactos y aciertos de ganador/empate sin marcador exacto'),
