...
// Horarios oficiales FIFA del calendario de eliminatoria, en UTC.
// Fuente: calendario oficial (EDT) convertido a UTC (EDT = UTC-4 en julio).
// NOTA: si en admin se cargan los partidos reales de eliminatoria con su hora,
